...
---------------------------------------------- SET POSITION OF HOOP 1 ------------------------------------------------------
    if msg.data == 500 then
        sim.setObjectPosition(emulation,-1,{0.13*whycon_msg.poses[1].position.x,-0.13*whycon_msg.poses[1].position.y,1.1229})
...
---------------------------------------------- SET POSITION OF HOOP 3 --------------------------------------------------------
    ...
    if msg.data == 700 then
        sim.setObjectPosition(emulation,-1,{0.13*whycon_msg.poses[1].position.x,-0.13*whycon_msg.poses[1].position.y,0.67})
...
---------------------------------------------- SET POSITION OF OBSTACLE 1  ------------------------------------------------------
    ...
    if msg.data == 2000 then
        sim.setObjectPosition(obstacle,-1,{0.13*whycon_msg.poses[1].position.x,-0.13*whycon_msg.poses[1].position.y,1.3345})
        sim.setObjectPosition(position_3,emulation,{0,0,0})
    end
-----------------------------------------------------------------------------------------------------------------------------------
