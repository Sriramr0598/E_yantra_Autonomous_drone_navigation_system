...
function sysCall_init()
    ...
    simOMPL.setCollisionPairs(t,{sim.getObjectHandle('eDrone_outer'),sim.getObjectHandle('hoop_visible3'),sim.getObjectHandle('base_of_hoop_40cm')})
...
function sysCall_actuation()
 ...
 ----------- To choose which path to compute based on goal_id --------------------------------------
        ...
        if goal_id == 1 then
            ...
            start_pose = getpose(front_handle33,-1)
        end
        -- if goal_id == 2 then
